...
Route.delete('/api/barang-kalibrasi/id', 'BarangKalibrasiController.destroy')
...
Route.delete('/api/barang-status/id', 'BarangStatusController.destroy')
...
Route.delete('/api/data-pengamatan/id', 'DataPengamatanController.destroy')
...
Route.delete('/api/data-ukur/id', 'DataUkurController.destroy')
...
Route.delete('/api/invoice-order/id', 'InvoiceOrderController.destroy')
...
Route.delete('/api/invoice-status/id', 'InvoiceStatusController.destroy')
...
Route.delete('/api/merk-barang/id', 'MerkBarangController.destroy')
...
Route.delete('/api/order-detail/id', 'OrderDetailController.destroy')
...
Route.delete('/api/order-status/id', 'OrderStatusController.destroy')
...
Route.delete('/api/posisi-ukur/id', 'PosisiUkurController.destroy')
...
Route.delete('/api/progres-order/id', 'ProgresOrderController.destroy')
...
Route.delete('/api/satuan-sensor/id', 'SatuanSensorController.destroy')
...
Route.delete('/api/seq-data-ukur/id', 'SeqDataUkurController.destroy')
...
Route.delete('/api/status-pengamatan/id', 'StatusPengamatanController.destroy')
...
Route.delete('/api/transaksi-broker/id', 'TransaksiBrokerController.destroy')
...
Route.delete('/api/transaksi-broker-status/id', 'TransaksiBrokerStatusController.destroy')
...
Route.delete('/api/unsur-kajiulang/id', 'UnsurKajiUlangController.destroy')
...
Route.delete('/api/unsur-kalibrasi/id', 'UnsurKalibrasiController.destroy')
