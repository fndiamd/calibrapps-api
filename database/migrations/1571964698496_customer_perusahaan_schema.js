...
class CustomerPerusahaanSchema extends Schema {
  up () {
    this.create('customer_perusahaans', (table) => {
      ...
      table.string('customer_perusahaan_pkal', 20)
      table.string('customer_perusahaan_nama', 150)
      table.text('customer_perusahaan_alamat', 'mediumtext')
      table.string('customer_perusahaan_telepon', 20)
      table.string('customer_perusahaan_fax', 20)
      table
        .integer('customer_status_id')
        .unsigned()
