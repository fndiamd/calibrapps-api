...
class DataUkurSchema extends Schema {
  up() {
    this.create('data_ukurs', (table) => {
      ...
      table.integer('data_ukur_panjang_benda')
      table.integer('data_ukur_lebar_benda')
      table.integer('data_ukur_tinggi_benda')
      table.integer('data_ukur_posisi_1')
      table.integer('data_ukur_posisi_1_2')
      table.integer('data_ukur_posisi_2_3')
      table.integer('data_ukur_posisi_3')
